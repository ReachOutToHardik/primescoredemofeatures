  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-6 pt-32 pb-12 relative overflow-hidden bg-night">
      ...
      <div className="relative z-10 max-w-md w-full text-center">
        {/* Server Crash Icon */}
        <div className="inline-flex items-center justify-center p-4 bg-brandNavy/5 border border-brandNavy/10 text-brandNavy rounded-3xl mb-6">
          <ServerCrash size={36} />
        </div>

        {/* Heading */}
        <h1 className="text-3xl font-display font-extrabold tracking-tight text-brandNavy mb-3">
          503 — Maintenance Underway
        </h1>
        <p className="text-textSecondary text-sm mb-8 leading-relaxed max-w-sm mx-auto">
          We are currently optimization-tuning the database servers. Services will resume shortly. Thank you for your patience.
        </p>
