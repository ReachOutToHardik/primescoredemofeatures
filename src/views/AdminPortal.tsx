...
export default function AdminPortal() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-20 px-4 sm:px-6 lg:px-12">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-end mb-8">
          <h1 className="text-3xl sm:text-4xl font-display font-bold text-gray-900">Admin Portal</h1>
          <button onClick={handleLogout} className="text-gray-500 hover:text-red-500 font-bold transition-colors text-sm px-4 py-2 rounded-lg hover:bg-red-50 flex items-center gap-2">
