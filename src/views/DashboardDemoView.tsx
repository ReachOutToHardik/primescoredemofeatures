...
export default function DashboardDemoView() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6F9] text-slate-800 flex flex-col font-sans selection:bg-[#253B7E]/10">
      <div className="flex-1 flex flex-col lg:flex-row min-h-screen">

        {/* Left Sidebar */}
        <aside className="w-full lg:w-[220px] lg:h-screen lg:max-h-screen lg:sticky lg:top-0 bg-white border-r border-slate-200/80 p-4 lg:py-6 lg:px-4 flex flex-col justify-between shrink-0 overflow-y-auto z-20">
          <div>
            {/* Logo */}
            ...
            <nav className="space-y-1.5">
              {[
                ...
                { name: 'Credit Reports', icon: FileText, active: false, hasChevron: true, href: '/dashboard' },
                { name: 'Disputes', icon: AlertTriangle, active: false, href: '/dashboard/disputes' },
                { name: 'Subscription', icon: CreditCard, active: false, href: '/dashboard' },
                { name: 'Refer & Earn', icon: Share2, active: false, href: '/dashboard' },
                { name: 'Profile', icon: User, active: false, href: '/dashboard' },
              ].map((item, idx) => {
                ...
                return (
                  <Link
                    key={idx}
                    href={item.href}
                    className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${item.active
          ...
          <div className="pt-6 space-y-3">
            ...
            {/* Refresh Now Button */}
            <button className="w-full bg-[#1B1B3A] hover:bg-[#2A2A56] text-white font-bold text-xs py-2.5 rounded-xl transition-all shadow-sm">
              Refresh Now
            </button>

            {/* Bottom Nav Links */}
            <div className="space-y-2 text-xs text-slate-600 pt-2 px-1">
              <a href="#" onClick={(e) => e.preventDefault()} className="flex items-center gap-3 py-1 hover:text-slate-900 transition-colors">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-7 space-y-5">
          ...
          <div className="flex items-center justify-end gap-3">
            <button className="bg-[#1B1B3A] hover:bg-[#2A2A56] text-white font-semibold text-xs px-3.5 py-1.5 rounded-md transition-all shadow-sm">
              Refresh Now
            </button>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <button className="bg-[#4338CA] hover:bg-[#3730A3] text-white font-semibold text-xs px-3.5 py-2 rounded-lg transition-all flex items-center gap-1.5 shadow-sm">
                  ...
                  <button className="bg-[#4338CA] hover:bg-[#3730A3] text-white font-semibold text-xs px-3.5 py-2 rounded-lg transition-all flex items-center gap-1.5 shadow-sm">
                    <FileText className="w-3.5 h-3.5" /> Credit Report Overview
                  </button>
                </div>
              </div>
