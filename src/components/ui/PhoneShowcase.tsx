...
export default function PhoneShowcase() {
  ...
  return (
    <div 
      ...
      className="relative flex justify-center items-center perspective-2000 h-[500px] md:h-[700px] w-full"
    ...
    >
      ...
      >
        ...
        <div className="relative w-full h-full rounded-[40px] md:rounded-[46px] overflow-hidden translate-z-[1px] bg-white">
          ...
          {/* Content Area */}
          <div className="w-full h-full flex flex-col overflow-y-auto no-scrollbar pt-10">
            {/* Header Container */}
              ...
              <div className="flex items-center gap-4 border-b border-slate-100 min-w-max pb-1">
                {["Overview", "Accounts", "Enquiries", "Comparison"].map((tab) => (
                  ...
                  >
                    {tab}
                    {tab === "Comparison" && (
                      <motion.div layoutId="tab-underline" className="absolute bottom-0 left-0 w-full h-[2px] bg-brandNavy" />
                    )}
                  </button>
                ))}
              </div>
            ...
            {/* Navbar Mobile */}
            <div className="mt-auto bg-white border-t border-slate-100 flex justify-between items-center px-8 py-4 z-20">
              <Home className="w-5 h-5 text-brandBlue" />
