...
export default function BusinessFooter() {
  return (
    <footer className="mt-20 border-t border-brandNavy/8 bg-white" data-theme="light">
      <div className="mx-auto max-w-[1440px] px-4 py-14 sm:px-6 lg:px-12">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-2">
            {/* Platform / Solutions */}
            <div>
              <div className="text-xs font-semibold uppercase tracking-wider text-brandNavy">Solutions</div>
              <div className="mt-4 grid gap-2.5">
                ...
                <Link className={footerLink} href="/business#process">Our Process</Link>
                <Link className={footerLink} href="/business#pricing">Corporate Pricing</Link>
                <Link className={footerLink} href="/business#audit-form">Initiate Audit</Link>
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 grid gap-6 sm:grid-cols-2">
              <div className="flex flex-col gap-2.5">
                ...
                <a className={footerLink} href="tel:+919460888899">+91 94608-88899</a>
